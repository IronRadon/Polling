...
ActiveRecord::Schema.define(:version => 20131206193834) do
  ...
  add_index "answerchoices", ["question_id"], :name => "index_answerchoices_on_question_id"
  add_index "answerchoices", ["text"], :name => "index_answerchoices_on_text", :unique => true
